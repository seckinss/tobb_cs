...
class TopTopPanel extends JPanel implements MouseInputListener {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // g.fillRect((int)((double)getSize().width/5-35),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        // g.setColor(Color.RED);
        // g.fillRect((int)((double)getSize().width/5-35) +
        // (int)(1.0*getSize().width/10),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        // g.setColor(new Color(0,176,80));
        // g.fillRect((int)((double)getSize().width/5-35) +
        // (int)(2.0*getSize().width/10),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        // g.setColor(Color.YELLOW);
        // g.fillRect((int)((double)getSize().width/5-35) +
        // (int)(3.0*getSize().width/10),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        // g.setColor(new Color(240,131,48));
        // g.fillRect((int)((double)getSize().width/5-35) +
        // (int)(4.0*getSize().width/10),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        // g.setColor(new Color(128,0,128));
        // g.fillRect((int)((double)getSize().width/5-35) +
        // (int)(5.0*getSize().width/10),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        // g.setColor(Color.BLACK);
        // g.fillRect((int)((double)getSize().width/5-35) +
        // (int)(6.0*getSize().width/10),getSize().height/5+4 ,
        // (int)((double)getSize().width/10-5), 35);
        g.setColor(new Color(79, 113, 190));
    ...
    public void mousePressed(MouseEvent e) {
        int x = e.getX();
        int y = e.getY();
        // if(x>(int)((double)getSize().width/5-35)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
        // referanceDPanel.c=new Color(79, 113, 190);
        // }
        // if(x>(int)((double)getSize().width/5-35) +
        // (int)(1.0*getSize().width/10)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)(6.0*getSize().width/10) +
        // (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
        // referanceDPanel.c=Color.RED;
        // }
        // if(x>(int)((double)getSize().width/5-35)+
        // (int)(2.0*getSize().width/10)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)(6.0*getSize().width/10) +
        // (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
        // referanceDPanel.c=new Color(0,176,80);
        // }
        // if(x>(int)((double)getSize().width/5-35) +
        // (int)(3.0*getSize().width/10)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)(6.0*getSize().width/10) +
        // (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
        // referanceDPanel.c=Color.YELLOW;
        // }
        // if(x>(int)((double)getSize().width/5-35) +
        // (int)(4.0*getSize().width/10)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)(6.0*getSize().width/10) +
        // (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
        // referanceDPanel.c=new Color(240,131,48);
        // }
        // if(x>(int)((double)getSize().width/5-35) +
        // (int)(5.0*getSize().width/10)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)(5.0*getSize().width/10) +
        // (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
        // referanceDPanel.c=new Color(128,0,128);
        // }
        // if(x>(int)((double)getSize().width/5-35) +
        // (int)(6.0*getSize().width/10)&&y>getSize().height/5+4&&x<(int)((double)getSize().width/5-35)
        // + (int)(6.0*getSize().width/10) +
        // (int)((double)getSize().width/10-5)&&y<getSize().height/5+39){
